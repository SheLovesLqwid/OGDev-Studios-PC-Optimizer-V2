# OGDev Studios PC Optimizer Changelog

## [16.7] - 2025-04-27
- Major: Updated all GitHub repository links
- Major: Professional documentation overhaul
- Improved: Enhanced security analysis and malware removal verification
- Fixed: Updated all internal references
...
## [15.3] - 2023-05-18
- New: Automation engine by using reusable templates (https://github.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer/blob/main/AUTOMATION.md)
