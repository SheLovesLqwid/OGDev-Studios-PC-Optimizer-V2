...
namespace Optimizer
{
    public sealed partial class MainForm : Form
    {
        ...
        readonly string _feedLink = "https://raw.githubusercontent.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer/main/feed.json";
        readonly string _feedImages = "https://raw.githubusercontent.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer/main/images/feed.zip";

        readonly string _licenseLink = "https://www.gnu.org/licenses/gpl-3.0.en.html";
        readonly string _discordLink = "https://discord.gg/vu47awhXRv";
        readonly string _githubProjectLink = "https://github.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer";
        readonly string _paypalSupportLink = "#";

        readonly string _latestVersionLink = "https://raw.githubusercontent.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer/main/version.txt";
        readonly string _changelogRawLink = "https://raw.githubusercontent.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer/main/CHANGELOG.md";
        readonly string _faqSectionLink = "https://github.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer/blob/main/FAQ.md";

        readonly string _bugReportLink = "https://github.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer/issues/new?assignees=&labels=&projects=&template=bug_report.md&title=";
        readonly string _featureRequestLink = "https://github.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer/issues/new?assignees=&labels=&projects=&template=feature_request.md&title=";
        ...
        {
            return string.Format("https://github.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer/releases/download/{0}/OGDev-Studios-PC-Optimizer-{0}.exe", latestVersion);
        }
