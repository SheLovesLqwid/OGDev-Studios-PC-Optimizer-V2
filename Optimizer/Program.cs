    ...
    static class Program
    {
        ...
        static void Main(string[] switches)
        {
            ...
            if (switches.Length == 1)
            {
                ...
                if (arg == "/version")
                {
                    if (!EXPERIMENTAL_BUILD) MessageBox.Show($"OGDev Studios PC Optimizer: {GetCurrentVersionTostring()}\n\nCoded by: OGDev Studios © ∞\n\nhttps://github.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer", "OGDev Studios PC Optimizer", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    else MessageBox.Show("OGDev Studios PC Optimizer: EXPERIMENTAL BUILD. PLEASE DELETE AFTER TESTING.\n\nCoded by: OGDev Studios © ∞\n\nhttps://github.com/SheLovesLqwid/OGDev-Studios-PC-Optimizer", "OGDev Studios PC Optimizer", MessageBoxButtons.OK, MessageBoxIcon.Information);
